...
$workdir=$datadir.$sample."/".$phe."/virusfinder1/output/step3/b-align/";
...
#	}
	...
	$cmd1="samtools view $workdir"."alignment.sorted.bam ".$pos[2*$i].":".($pos[2*$i+1]-1000)."-".($pos[2*$i+1]+1000)."> temp201";
	`$cmd1`;
	print $cmd1,"\n";
