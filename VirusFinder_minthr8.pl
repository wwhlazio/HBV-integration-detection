...
my $detect_integration_script = "$script_dir/detect_integration_minthr8.pl";
...
sub RunSensitiveMode {
    ...
    print "g_lower,g_upper,g_mean:$g_lower,\t,$g_upper,\t,$g_mean\n";	
	...
	print "$icorn_dir/icorn.start.sh refseq.fa 1 $sensitivity_level unmapped.1.fq unmapped.2.fq $g_lower,$g_upper $g_mean $icorn_dir\n";
        `$icorn_dir/icorn.start.sh refseq.fa 1 $sensitivity_level unmapped.1.fq unmapped.2.fq $g_lower,$g_upper $g_mean $icorn_dir`;
    }
